...
public final class WildFlyElytronAuthClientProvider extends WildFlyElytronBaseProvider {

    private static final long serialVersionUID = -3770297685039711294L;
    private static WildFlyElytronAuthClientProvider INSTANCE = new WildFlyElytronAuthClientProvider();

    /**
     * Construct a new instance.
     */
    public WildFlyElytronAuthClientProvider() {
     ...
     */
    public static WildFlyElytronAuthClientProvider getInstance() {
        return INSTANCE;
    }
